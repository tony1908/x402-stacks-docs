...
export const Header: React.FC<HeaderProps> = ({ onMenuClick, theme, onToggleTheme }) => {
  return (
    <header className="fixed top-0 left-0 right-0 h-14 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 z-50 px-4 flex items-center justify-between transition-colors duration-200">
      ...
      <div className="flex items-center gap-2 text-slate-500 dark:text-slate-400">
         ...
         <a href="https://github.com/tony1908/x402Stacks" target="_blank" rel="noopener noreferrer" className="p-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-md transition-colors hidden sm:block">
         ...
         <a href="https://x.com" target="_blank" rel="noopener noreferrer" className="p-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-md transition-colors hidden sm:block">
